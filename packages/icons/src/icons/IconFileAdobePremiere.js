...
const SvgIconFileAdobePremiere = props => (
  <svg viewBox="0 130.746 595.279 580.398" width="1em" height="1em" {...props}>
    <radialGradient
      id="a"
      cx={-183.69}
      cy={328.972}
    ...
    >
      <stop offset={0} stopColor="#4b2d4f" stopOpacity={0.98} />
...
export default SvgIconFileAdobePremiere;
